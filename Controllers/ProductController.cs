...
namespace e_store.Controllers
{
    public class ProductController : Controller
    {
        ...
        // GET: Product
        [HttpGet("Product")] 
        [HttpGet(@"Product/{slug:regex(^(?!Details$).*$)?}/{brandName?}")]        public async Task<IActionResult> Index(string? slug, string? brandName, string? searchQuery, string? sortOrder)
        {
        ...
        // public async Task<IActionResult> Create([Bind("Id,Name,BrandId,Description,Price,InventoryCount,ImageUrl,CreatedDate,IsActive,SKU,CategoryId")] Product product)
        // {
        ...
        //     
        //     string catPart = cleanCategory.Substring(0, 4).ToUpper();
        //     string prodPart = cleanName.Substring(0, 4).ToUpper();
        //     string brandPart = cleanBrand.Substring(0, 4).ToUpper();
        //     
        //     int existingCount = _context.Products.Count();
        //     int newCount = existingCount + 1;
        //     
        //     // You'd query the DB for the count of items in this category to get the ID
        ...
        // [HttpPost]
        // [ValidateAntiForgeryToken]
        // public async Task<IActionResult> Edit(int id, [Bind("Id,Name,BrandId,Description,Price,InventoryCount,ImageUrl,CreatedDate,IsActive,SKU,CategoryId")] Product product)
        // {
        //     if (id != product.Id)
        //     {
        //         return NotFound();
